...
ALLOWED_HOSTS = []
# Render injecte automatiquement cette variable avec votre URL publique
RENDER_EXTERNAL_HOSTNAME = os.getenv('RENDER_EXTERNAL_HOSTNAME', default=None)
...
DATABASES = {
    ...
    'postgres' : { # This is the alias for the postgres database you re using
        'ENGINE' : 'django.db.backends.postgresql',
...
# MODIFYING THE DEFAULT USER MODEL TO CustomUser we created 
# This tells Django to use our CustomUser model instead of the default django.contrib.auth.models.User.
